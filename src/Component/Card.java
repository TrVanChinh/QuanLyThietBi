...
public class Card extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/setting.png"))); // NOI18N
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.fillOval(getWidth() - (getHeight() / 2), getHeight()/2 + 20, getHeight(), getHeight());
